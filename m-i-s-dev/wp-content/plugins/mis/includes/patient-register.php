	...
	function patient_register_form ()
	{
		...
		if (!filter_input_array(INPUT_POST)):
            ...
            <div class="form-group">
                <label for="returning-patient">Returning Patient
                    <input type="radio" name="patient_returning_new" value="r" id="returning-patient">
                </label>
                <label for="new-patient">New Patient
                    <input type="radio" name="patient_returning_new" value="n" id="new-patient">
                </label>
            </div>
            <form action='#' method="POST" id="patient-registration-form" style="display: none">
                ...
                <div id="general-registration-inputs">
                    <div class="form-group">
                        <label for="name"><?php _e('Name: ', 'trs'); ?></label>
                        <input class="form-control" type="text" name="mis-name" id="name" value=""
                               placeholder="Enter patient name">
                    </div>

                    <div class="form-group">
                        <label for="phone-number"><?php _e('Phone Number:', 'trs'); ?> </label>
                        <input maxlength="13" class="form-control" type="text" name="mis-phone-number" id="phone-number"
                               value="" placeholder="Enter Patient Phone Number">
                    </div>

                    <div class="form-group">
                        <label for="age"><?php _e('Age:', 'trs'); ?> </label>
                        <input class="form-control" type="text" name="mis-age" id="age" value=""
                ...
                <div class="form-group">
                    <input type="submit" id="regform_submit">
                </div>
        ...
        elseif (filter_input_array(INPUT_POST) && isset($_GET['step'])):
			...
			SOLUTION:
			--> IMPORTANT <-- second or third or multiple visits must be treated as separate orders with unique orderID
